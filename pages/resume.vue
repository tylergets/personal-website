<template>
  <div class="mx-auto max-w-7xl p-5">
    <div class="md:flex justify-between items-center mb-3">
      <div class="space-y-4">
        <h1 class="text-5xl md:text-6xl font-bold">Tyler Getsay</h1>
    ...
    <div class="md:grid gap-5 space-y-4 grid-cols-4">
      <div class="leading-relaxed col-span-4">
        ...
        <p>
          I am a 10+ year software developer living in the Cincinnati area. I build full stack applications in a fraction of the time as others by leveraging years of experience with my environment and every bit of the modern web/mobile application stack. My applications have been used by millions and have correspondingly produced millions in revenue for my partners.
        </p>
      </div>
    ...
    return {
      ...
      experience: [
        ...
        },
        {
          ...
          description: "I built a crowdfunding-based ticketing platform on Laravel, a popular PHP-MVC framework. The application is robust, featuring many third party integrations and backend management features. I also act the role of tech visionary for the company."
        }
      ]
    }
  }
